...
# -- load vtypes -----------------------------------------------------------------------------------
# ==================================================================================================
_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "sumo_integration", "vtypes.json")
...
def main(route_files, vtypes, _random=False, tag='vehicle'):
    """
    ...
    for filename in route_files:
        ...
        logging.info('modified %d vtype(s) in %s for tag %s', counter, filename, tag)
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--tag',
                           default="vehicle",
                           help="Tag that we will change. 'vehicle' or 'person'.")
    ...
    main(args.route_files, filtered_vtypes, args.random, args.tag)
